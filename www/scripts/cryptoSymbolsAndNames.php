...
/**
 * Contains key value pairs of all symbols and names for the crypto data in $cryptoData
 * "symbol" => "name"
 * @var array $cryptoSymbolsAndNames = [
 *      "symbol" => "name"
 * ]
 * Ex: "BTC" => "Bitcoin"
 */
...
// symbol should be MIOTA
// Symbol Originally was YOYOW
